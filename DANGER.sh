clear
toilet RED-$P@M | lolcat
sleep 1
echo "\033[38;1m ------------------------------------------------------------------"|lolcat
echo "\033[31;1m #Security Cyber Script Kiddie"
echo "\033[36;1m author by :"
echo "\033[36;1m RED 💘 HAT | CLAY | Mr-X"
...
echo ""
sleep 1
     echo "\033[34;1m TUH SPAM NYA BANGSAT "
     echo "   '(01)'JDID "
     echo "   '(02)'TELKOMSEL "
     echo "   '(03)'PHD.      "
     echo "   '(04)'MATHARIMALL"
...
echo "Dibuat oleh "
echo "RED 💘 HAT | CLAY | Mr-X"
echo "versi 0.1"
echo "THANKS TO ALL MEMBER RED-$P@M"
echo ""
fi
...
echo "semoga hari mu menyenangkan BANGSAT🖕"
echo "github.com/19LhansBeutik33"
echo ""
echo "SILAHKAN DI ReCode Atau Ganti Author"
echo "LALU JADILAH "ANNONYM" [TIDAK DIKETAHUI]"
echo "pepatah RED-HAT [Incarlah Sesuatu Yang Mustahil]"
fi
